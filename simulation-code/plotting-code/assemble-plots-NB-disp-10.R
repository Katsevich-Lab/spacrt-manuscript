...
# The following chunk of code is to produce left-sided plot; this code is for Figure 16
...
# The following code is used to produce the right-sided test; this code is for Figure 17

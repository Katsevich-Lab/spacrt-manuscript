...
######################
# plot the result for Type-I error; this code is for Figure 8
...
################################################################################
# The following code is for right-sided test; this code is for Figure 9
################################################################################
...
# The following chunk of code is to produce left-sided plot; this code is for Figure 14
...
beta_rho_plot <- power_result |>
  ...
  scale_x_continuous() +
  scale_y_log10() +
  ggh4x::facet_grid2(metric ~ gamma_0, scales = "free_y") +
  geom_point(size = 0.5) +
  geom_line() +
  geom_hline(aes(yintercept = metric.num), linetype = "dashed", color = "red") +
  theme_bw() +
...
# The following code is used to produce the right-sided test; this code is for Figure 15
...
################################################################################
# The following code is to plot the left-sided test; this code is for Figure 8
################################################################################
...
################################################################################
# The following code is to plot the right-sided test; this code is for Figure 9
################################################################################
plot_gamma <- p_value_df_null |>
  dplyr::filter(gamma_0 == default_gamma &
                  sideness == "right" &
